class DropBoxController{
    ...
    connectFirebase(){
        var config = {
            apiKey: "AIzaSyC4b-xZZoD8_85oPJ_LXYHFwKeC63IV4pY",
            authDomain: "dropbox-clone-c7ad0.firebaseapp.com",
            databaseURL: "https://dropbox-clone-c7ad0-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-c7ad0",
            storageBucket: "dropbox-clone-c7ad0.appspot.com",
            messagingSenderId: "698210423545",
        };
            ...
            this.uploadTask(event.target.files)
              .then((responses) => {
                responses.forEach((resp) => {
                    ...
                    console.log(resp.files.filepath);
                });
            ...
            if ((i+1) === this.currentFolder.length){
                ...
                span.innerHTML = `
                    <span class="ue-effect-container uee-BreadCrumbSegment-link-0">
                        <a href="#" data-path="${path.join('/')}" path" class="breadcrumb-segment">${folderName}</a>
                    </span>
    ...
    initEventsLi(li){
        ...
        li.addEventListener('dblclick', e=>{
            ...
            switch(file.mimetype){
                ...
                default:
                    window.open('/file?path='+ file.filepath.replace("D:\\\Repositorio\\\Estudo\\\JavaScript\\\DropboxClone\\\app\\", ""));
            }
        });
