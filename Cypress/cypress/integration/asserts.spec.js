...
it('Strring', () =>{
    ...
    expect(str).to.match(/de/) //possui
    expect(str).to.match(/^String/) //iniciar com
    expect(str).to.match(/teste$/) //terminar com
    expect(str).to.match(/.{15}/) //contenha 15 caracteres
    expect(str).to.match(/\w+/) //somente letras
    expect(str).to.match(/\D+/) //nao contenha numeros
